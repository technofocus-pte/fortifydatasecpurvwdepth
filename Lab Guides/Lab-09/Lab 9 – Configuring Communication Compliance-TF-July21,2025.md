...
2.  Scroll down and select the checkbox beside **Communication
...
**Note**: In case, you did not see My first communication compliance
policy, then refresh the page.
...
**Note**: In case, **Save** button is not highlighted, then select some
other feature radio button, and select again **Show anonymized versions
