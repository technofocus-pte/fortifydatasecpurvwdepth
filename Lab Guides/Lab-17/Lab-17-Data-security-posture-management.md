...
1. Work a data security objective
1. Run a data risk assessment for potential oversharing
1. Review AI observability for apps and agents
1. Review posture reports
...
1. In the left navigation, select **Solutions** > **DSPM**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image1.png)

1. On the **DSPM and DSPM for AI unified in one solution** page, select **Get started**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image2.png)

1. On the **Complete setup to unlock the unified DSPM experience** page, review the **Auditing and analytics** card. It confirms that Audit and Insider Risk Management analytics are already enabled (from Lab 0) and that DLP analytics will be enabled during setup.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image3.png)

1. Select **Start setup**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image4.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image5.png)
...
1. In **DSPM**, select **Objectives**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image6.png)

1. Review the data security objectives presented as outcome cards — for example **Prevent oversharing of sensitive data**, **Prevent exfiltration to risky locations**, **Prevent data exposure in Copilot interactions**, and **Discover sensitive data in your organization**.

1. Select any one objective.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image7.png)

1. Review the objective's guided plan. It lays out the recommended steps to achieve the outcome, shows key metrics such as the share of data covered by policies, and lists prioritized actions you can apply directly. Note how the plan references the specific Purview solutions involved — labels, DLP, and insider risk — that you configured in earlier labs.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image8.png)

1. Review the actions the objective recommends. Where an action lets you create or strengthen a policy, it hands off to the owning Purview solution to complete the configuration (you create a policy this way in Task 6).

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image9.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image10.png)
...
1. Review the assessments. DSPM provides a **default assessment** that highlights oversharing across your most-used sites; you can also create a custom assessment. Select **+ Create custom assessment**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image11.png)

1. On the **Basic details** page, enter the following:

    - **Name**:

        `Unlabeled trial content assessment`

    - **Description**:

        `Identifies unlabeled SharePoint and OneDrive content that could be overshared and helps prioritize remediation of Contoso trial and research data.`


1. Select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image12.png)

1. On the **Select scan level** page, leave **Source-level** selected, then select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image13.png)

1. On the **Add users** page, select **All**, then select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image14.png)

1. On the **Add data sources to assess** page, select **SharePoint** and **OneDrive**, then select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image15.png)

1. On the **Review and run the data assessment scan** page, review the scope, then select **Save and run**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image16.png)

1. On the confirmation page, select **Done**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image17.png)
...
1. In **DSPM**, select **Discover** > **Apps and agents**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image18.png)

1. Review the dashboard of AI apps and their agents that have been used across the organization — for example Microsoft 365 Copilot and the agent published in your Copilot Studio trial. The dashboard shows the top most-recently-used agents.

1. Select an agent to open its details, and review the sensitive data it accessed and how it's protected by Microsoft Purview policies.

1. Select **Discover** > **Activity explorer**, then select the **AI activities** tab, to review AI interactions in detail — for example, prompts and responses that touched sensitive information types such as the compound or trial classifiers from Lab 2.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image19.png)

1. Relate this to Contoso's scenario: AI observability is what would have caught the founding incident — a compound identifier surfaced through an AI app, or pre-publication results reached via an overshared site — by showing the agent activity and flagging the risk.
...
1. In **DSPM**, select **Reports**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image20.png)

1. Review the available reports. DSPM provides a set of reports covering posture and policy activity — including:
...
1. Open the **Microsoft 365 Copilot** report and review its visuals — for example, how much of the data Copilot can reach is labeled or protected, and where gaps remain.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image21.png)

1. Use the filters and drilldowns in a report to pinpoint a specific gap — for example, unlabeled content that Copilot can access — which becomes a prioritized action for Contoso.
...
1. In **DSPM**, select **Actions** (or **Tasks and actions**) > **Remediation actions**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-17/media/image22.png)

1. Review the recommended remediation actions. Select the recommendation for **Detect risky interactions in AI apps** (a policy that restricts high-risk users from pasting or uploading sensitive data into generative AI sites, using Adaptive Protection).

1. Review the recommendation summary.

1. You can review and complete the rest of the recommendations.
