...
1. Enable scoped directory search in Microsoft Teams
1. Create an allow-mode barrier policy in the portal
1. Create the remaining allow-mode policies with PowerShell
1. Apply the policies and verify enforcement
1. Understand Information Barriers modes
...
1. Install the Exchange Online module and connect to Security & Compliance PowerShell. When the sign-in window appears, sign in as **Allan Deyoung**, `AllanD@TenantName`:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%201.31.23%E2%80%AFPM.png)

1. Create the department-based segments for the clinical/research and commercial functions:
...
1. Create the Project Falcon deal-team segment from its existing group. Replace the group address with the actual Project Falcon group address in your tenant:

    `New-OrganizationSegment -Name "Project Falcon" -UserGroupFilter "MemberOf -eq 'Falcon@TenantName'"`

1. Confirm all segments were created and review their filters:

    `Get-OrganizationSegment | Format-List Name, UserGroupFilter, Type`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%201.38.08%E2%80%AFPM.png)
...
1. In the left navigation, select **Teams** > **Teams settings**.

1. Under **Search by name**, set **Scope directory search using an Exchange address book policy** to **On**, then select **Save**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%201.50.04%E2%80%AFPM.png)

1. If a dialog notes the change may take time to take effect, select **Confirm**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.21.46%E2%80%AFPM.png)
...
1. On the **Name** page, in the **Name** field, enter `Research-Allow`, then select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.40.50%E2%80%AFPM.png)

1. On the **Assigned segment** page, select **Choose segment**, select **Research**, then select **Add**. (You can select only one assigned segment.) Select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.41.09%E2%80%AFPM.png)

1. On the **Communication and collaboration** page, in the **Communication and collaboration** field select **Allowed**. Then select **Choose segment** and add each of the following, so Research is permitted to communicate only with them. Then select **Next**.

    - **Research**
    - **HR**
    - **Marketing**

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.41.50%E2%80%AFPM.png)
...
1. On the **Configure policy status** page, set the status to +++On+++, then select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.43.30%E2%80%AFPM.png)

1. On the **Review your settings** page, review the configuration and any warnings, then select **Submit**. When the policy is created, select **Done**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.43.57%E2%80%AFPM.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.44.25%E2%80%AFPM.png)
...
1. In the elevated terminal, still connected to Security & Compliance PowerShell, create the **Sales** policy (Sales may communicate only with Sales, HR, and Marketing — walled off from Research and Project Falcon):
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.53.46%E2%80%AFPM.png)

1. Create the **Marketing** policy (Marketing is a shared support function — it may communicate with Marketing, Research, Sales, and HR, but not Project Falcon):
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.55.37%E2%80%AFPM.png)

1. Create the **HR** policy (HR supports every function including the deal team — it may communicate with all segments):
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.56.09%E2%80%AFPM.png)

1. Create the **Project Falcon** policy (the deal team may communicate only with itself and the HR staff who support it — walled off from Research, Sales, and Marketing):
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.56.32%E2%80%AFPM.png)

1. Confirm all five policies exist (the portal-created `Research-Allow` plus the four above) and review their allow lists:

    `Get-InformationBarrierPolicy | Format-List Name, AssignedSegment, SegmentsAllowed, State`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.56.49%E2%80%AFPM.png)
...
1. In the elevated terminal, set the four PowerShell-created policies to active. (The portal-created `Research-Allow` was already created with status **On**; setting it active again is harmless if you prefer to include it.)
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%202.58.51%E2%80%AFPM.png)

1. Apply all active barrier policies across the organization. When prompted to confirm, press **Y** (do not use *Yes to All*; submit the application only once):

    `Start-InformationBarrierPoliciesApplication`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%203.02.29%E2%80%AFPM.png)

1. Check the application status. Re-run until it shows the application has completed:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%203.04.05%E2%80%AFPM.png)
...
1. After the application completes, verify that a **Research** user and a **Sales** user are barred from communicating. Replace the identities with a real Research-department user and a real Sales-department user in your tenant:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/main/Lab%20Guides/Lab-08/media/Screenshot%202026-08-31%20at%203.29.32%E2%80%AFPM.png)
...
1. Verify that a **permitted** pairing is *not* blocked. Confirm an HR user and a Project Falcon user can communicate — the one deliberate exception in the design (replace with real users in those segments):
...
1. As a behavioral verification, sign in to **Microsoft Teams** as a **Research** user (for example, Grady Archie) and attempt to start a chat with a **Sales** user (for example, Isaiah Langer). Confirm the Sales user cannot be found or messaged — the barrier removes them from search and blocks the chat.
