...
3.  在“**Provide a policy name**”页的“Name”字段中，输入策略的名称 -
    **+++Sales-Research+++**.。然后，选择“**Next**”。
    ...
    ![A screenshot of a  omputer AI-generated content may be incorrect.](./media/image14.png)

5.  在**Add assigned segment** 详细信息页上，选择“**Choose
...
3.  使用实验室环境主页上提供的 **MOD Administrator** 凭据登录。
    ...
    **注意：**如果 **Automatically sign in to all desktop apps and websites on this device?**出现对话框，然后单击“**No, this app only**”按钮。
