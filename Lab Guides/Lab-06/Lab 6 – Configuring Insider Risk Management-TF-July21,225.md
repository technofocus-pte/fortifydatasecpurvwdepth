...
1.  Click on the **Windows** icon, then click on **Settings** as shown
    in the below image.
...
25. If **User Account Control** dialog box appears, then click on the
    **Yes** button. ![A screenshot of a computer error AI-generated
    content may be incorrect.](./media/image43.png)

26. In the Command Prompt, press **Y** and press enter to confirm. You
...
28. On **User Account Control** dialog box, click on the Yes button. ![A
