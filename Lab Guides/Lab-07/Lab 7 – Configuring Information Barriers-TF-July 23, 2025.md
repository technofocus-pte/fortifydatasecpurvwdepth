...
1.  If prompted ‘**Do you want PowerShellGet to install and import the
...
4.  Log in using the **MOD Administrator** credentials given on the home
    page of the lab environment.

**Note**: In case, **Automatically sign in to all desktop apps and
websites on this device?** dialog box appears, then click on **No, this
app only** button.
...
5.  Run the following command one by one in the **PowerShell** to create
