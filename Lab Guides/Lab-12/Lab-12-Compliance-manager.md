...
1. Create a regulatory assessment
1. Explore improvement actions in the assessment
1. Work an improvement action
1. Understand automatic testing and scoring
...
1. Select the **Compliance Manager** solution card. The **Overview** page appears.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image1.png)

1. Review the **Compliance score** at the top of the Overview page. This percentage reflects how many improvement actions have been implemented and tested, weighted by their risk impact.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image2.png)

1. Review the score breakdown, which separates points achieved through **Microsoft-managed actions** (controls Microsoft operates for its cloud) from **your improvement actions** (controls Contoso is responsible for). Note the **Key improvement actions** listed, which are the highest-impact actions you can take next.

1. In the left navigation, select **Assessments**. Confirm the **Data Protection Baseline** assessment is present — this default assessment is what produced your initial score before any custom assessments were created.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image3.png)
...
1. In Compliance Manager, on the **Assessments** page, select **Add assessment** to start the assessment creation wizard.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image4.png)

1. On the **Base your assessment on a regulation** page, select **Select regulation**. Browse or search the templates (Compliance Manager provides ready-to-use templates for hundreds of regulations). Select a regulation relevant to Contoso — for example, a data-protection or health-information regulation such as **HIPAA/HITECH** — then **Save**. Select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image5.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image6.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image7.png)
...
1. On the assessment details page, enter a name, such as +++Contoso data protection assessment+++.

1. Assign the assessment to a **group**. Groups organize assessments and let you manage them together; select **Create new group**, such as `Contoso Compliance`, then select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image8.png)

1. Designate the **services** in scope for the assessment (the Microsoft 365 services the assessment evaluates), then complete the wizard to create the assessment.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image9.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image10.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image11.png)

1. Open the newly created **Contoso data protection assessment** and review its structure: it contains **controls** (the requirements from the regulation) and, under each control, the **improvement actions** that satisfy it.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image12.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image13.png)
...
1. Review the columns for each improvement action:
...
1. Note that many improvement actions correspond to controls configured earlier in this course — for example, actions relating to data loss prevention, sensitivity labeling, encryption, retention, and insider risk. Compliance Manager centralizes these into a single posture view.

1. Select an individual improvement action to open its details page, which shows the recommended implementation guidance, the points available, and the fields for tracking your work.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image14.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image15.png)
...
1. In the **Contoso data protection assessment**, select an improvement action that maps to a control you configured earlier — for example, an action about **Apply sensitivity labels to protect ePHI**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image16.png)

1. On the action's details page, assign it to an owner: select the option to assign the action, and select a user (for example, **Allan Deyoung**) to be responsible for it.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image17.png)

1. Update the **implementation status** — select **Edit details**, set it to +++Implemented+++ for a control you have configured in this course.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image18.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image19.png)

1. Add **evidence**: you can use the option to upload a file or add a note documenting how the control is implemented (for example, a note that the DLP policy from Lab 5 is enforced, or a screenshot of the sensitivity-label policy from Lab 4). Evidence, notes, and status updates are all stored within the improvement action.

1. Update the **test status** — for a manually tested action, set it to reflect that you have verified the control (for example, **Implemented** and tested), which qualifies the action for its points.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image20.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image21.png)

1. Select **Save and Close**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image22.png)

1. Confirm the action's **points achieved** and the assessment's score update to reflect the completed action.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image23.png)
...
1. In the assessment's **Improvement actions**, look for actions with a **Test status** of automatically tested. These are actions Compliance Manager verifies by detecting signals from other Microsoft solutions.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image24.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-12/media/image25.png)
...
1. Review how points roll up into the score. Each improvement action is worth points based on the risk it mitigates; as actions are implemented and tested — manually or automatically — their points contribute to the control's score, then to the assessment's score, and finally to the overall compliance score.

1. Note the distinction that shapes the score: Microsoft-managed actions are counted once, each technical action Contoso manages is counted once, and each non-technical action is counted once per group. This gives an accurate picture of Contoso's true implementation posture across all its assessments.
