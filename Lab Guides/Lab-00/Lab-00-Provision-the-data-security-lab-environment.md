...
1. Enable Insider Risk Management analytics and data sharing
...
1. Create the EDM data uploaders security group
...
1. In **Microsoft Edge**, navigate to +++https://purview.microsoft.com+++ and sign in as **MOD Administrator**, `admin@TenantName` (the Tenant Name and the Admin password are provided in the Resources tab of your lab environment).

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image1.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image2.png)

1. If a message about the new Microsoft Purview portal appears, select **Get started** to access the portal. Close the introduction/walk-through pane.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image3.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image4.png)

1. In the left navigation, select **Solutions**, then select **Audit**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image5.png)

1. On the **Audit** page, select the **Start recording user and admin activity** bar.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image6.png)

1. Confirm the blue bar disappears, which indicates auditing is now being enabled.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image7.png)
...
1. In the left navigation select **Settings**, then expand **Device onboarding**.

1. On the **Device onboarding** page, select **Devices**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image8.png)

1. On the **Devices** page, select **Turn on device onboarding**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image9.png)

1. When prompted, select **OK** to confirm that device monitoring is being turned on.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image10.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image11.png)
...
1. Toggle both of these settings to **On**:

    - **Show insights at tenant level**
    - **Show insights at user level**

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image12.png)


1. Select **Save** at the bottom of the page.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image13.png)

1. In the left navigation of the settings pane, select **Data sharing**.

1. Toggle **Share user risk details with other security solutions** to **On**.

1. Select **Save** at the bottom of the page.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image14.png)
...
1. In the navigation pane, select **Incidents & alerts** > **Incidents**.

1. If a message states that Microsoft Defender XDR is being prepared, allow the process to run — it completes automatically and can take a few minutes.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image15.png)
...
1. In **Microsoft Edge**, navigate to +++https://entra.microsoft.com/+++ and sign in using the **Admin** credentials. On the **Let's keep your account secure** prompt, select **Next**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image16.png)

1. On the **Start by getting the app** screen, install the **Microsoft Authenticator** app from your device's app store, or open it if it's already installed, then select **Next**. If you prefer a different app, select **I want to use a different authenticator app** and follow the on-screen instructions.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image17.png)

1. On the **Set up your account** screen, follow the instructions on your phone to allow notifications, then select **Next**. If Microsoft Authenticator is already installed and configured, you may not see this screen — continue to the next step.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image18.png)

1. On the **Scan the QR code** screen, use the Microsoft Authenticator app to scan the QR code displayed, then select **Next**.

1. On your phone, approve the sign-in request by entering the number shown in your browser.

1. On the **Notification approved** screen, select **Next**.
...
1. Select **Done**. Confirm you are redirected to the Microsoft Entra admin center.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image19.png)
...
1. In the left navigation, select **Solutions** > **Insider Risk Management** > **User** > **Adaptive Protection**, then select **Dashboard**.

1. Select **Quick setup**. A message indicates that Adaptive Protection is being set up.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image20.png)

1. Select the **Adaptive Protection settings** tab, toggle **Adaptive Protection** to **On**, then select **Save**. If you do not see the **Adaptive Protection settings** tab, refresh the page.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image21.png)
...
1. In the Microsoft 365 admin center, in the left navigation, expand **Teams & groups**, then select **Active teams & groups**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image22.png)

1. Select the **Security groups** tab, then select **+ Add a security group**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image23.png)

1. On the **Set up the basics** page, enter the following, then select **Next**:
    ...
    - **Description**:
        ...
        `Users authorized to hash and upload EDM source data.`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image24.png)


1. Leave the default settings, select **Next**, then select **Create group**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image25.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image26.png)

1. Select **Close**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image27.png)

1. On the **Active teams & groups** page, select the **Security groups** tab, then select **Refresh**.

1. Select the **EDM_DataUploaders** group.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image28.png)

1. Select the **Members** tab, then select **View all and manage owners**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image29.png)

1. Select **+ Add owners**, select the checkbox next to **MOD Administrator**, then select **Add**. Select **Back**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image30.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image31.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image32.png)

1. Select the **Members** tab, then select **View all and manage members**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image33.png)

1. Select **+ Add members**, select the checkbox next to **Allan Deyoung**, then select **Add**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image34.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image35.png)

1. Close the flyout, then close the InPrivate window.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-00/media/image36.png)
