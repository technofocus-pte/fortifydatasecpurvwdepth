...
25. 如果出现“**User Account Control**”对话框，请单击“**Yes**”按钮。![A
    screenshot of a computer error AI-generated content may be
    incorrect.](./media/image43.png)

26. 在命令提示符下，按 **Y** 并按 Enter
...
28. 在“**User Account Control**”对话框中，单击“**Yes**”按钮。![A
    screenshot of a computer error AI-generated content may be
    incorrect.](./media/image43.png)

29. 通过运行以下命令运行检测测试。命令提示符窗口将自动关闭。
...
1.  在 Microsoft Purview 门户中，单击“Solutions”，然后单击 **“Insider
    Risk Management”** ![](./media/image47.png)
