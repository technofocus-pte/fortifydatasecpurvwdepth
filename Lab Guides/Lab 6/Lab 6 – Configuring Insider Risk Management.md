...
27. コマンドプロンプトで**Yを押し**、Enterキーを押して確定します。デバイスがオンボードされたことを示すメッセージが表示されます。**Command
...
30. 次のコマンドを実行して検出テストを実行します。コマンドプロンプトウィンドウは自動的に閉じます。
...
3.  **「Policies」**をクリックします。「Policies」ページで、 **「+Create
...
5.  \[Close\]**ボタン**をクリックします。
    ...
    ![A screenshot of a computer AI-generated content may beincorrect.](./media/image91.png)
...
10. 「Decide whether to score only activity with priority
    ...
    ![A screenshot of a computer screen AI-generated content may be incorrect.](./media/image101.png)
...
14. **Detection optionsページ**でデフォルト設定を維持し、
    **\[Next\]を選択します**。
    ...
    ![A screenshot of a computer screen AI-generated content may be incorrect.](./media/image107.png)
