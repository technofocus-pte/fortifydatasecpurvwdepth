...
1. Create the Clinical Terms sensitive information type with PowerShell
1. Create the Compound ID sensitive information type with PowerShell
1. Create a document fingerprint from a standard form
1. Create the Clinical Trial Subject EDM classifier
1. Test the sensitive information types
1. Monitor classified content in Content and Activity Explorer
...
1. If the **Welcome to the new Microsoft Purview portal** dialog appears, select **Get started**.

1. In the left navigation, select **Solutions** > **Information Protection**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image1.png)

1. Expand **Classifiers**, then select **Sensitive info types**. On the **Sensitive info types** page, select **+ Create sensitive info type**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image2.png)

1. On the **Name your sensitive info type** page, enter the following, then select **Next**:

    - **Name**:

        `Contoso Clinical Trial Subject ID`

    - **Description**:

        `Detects Contoso clinical-trial subject identifiers (CTS- followed by six digits).`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image3.png)


1. On the **Define patterns for this sensitive info type** page, select **+ Create pattern**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image4.png)

1. On the **New pattern** flyout, leave **Confidence level** at **Medium confidence**. Select **+ Add primary element**, then select **Regular expression**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image5.png)

1. On the **Add a regular expression** flyout, enter the following:
...
1. Select the radio button for **String match**, then select **Done**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image6.png)

1. Under **Supporting elements**, select **+ Add supporting elements or group of elements**, then select **Keyword list**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image7.png)

1. On the **Add a keyword list** flyout, enter the following:
...
1. Select the radio button for **String match**, then select **Done**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image8.png)

1. Under **Character proximity**, set the **Detect primary AND supporting elements within** value to `300` characters.

1. Select **Create**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image9.png)

1. Back on the **Define patterns for this sensitive info type** page, select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image10.png)

1. On the **Choose the recommended confidence level to show in compliance policies** page, review the default and select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image11.png)

1. On the **Review settings and finish** page, review your settings and select **Create**. When the SIT is created, select **Done**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image12.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image13.png)
...
1. On the client VM, open an elevated terminal: right-click the **Start** button and select **Terminal (Administrator)**. Select **Yes** on the User Account Control prompt.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image14.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image15.png)

1. Connect to Security & Compliance PowerShell. When the sign-in window appears, sign in as **Allan Deyoung**, `AllanD@TenantName`:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image16.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image17.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image18.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image19.png)

1. Create the keyword dictionary from the confidential clinical terms:

    `$terms = "influenza`nbronchitis`notitis`nefficacy endpoint`nunblinding`nadverse event`nserious adverse event"`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image20.png)
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image21.png)
...
1. Confirm the dictionary was created and capture its identity (GUID). Copy the **Identity** value from the output — you'll paste it into the rule-package file in the next step:

    `Get-DlpKeywordDictionary -Name "Contoso Clinical Terms Dictionary" | Format-List Name, Identity`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image22.png)

1. Reference the dictionary in the rule-package file. In **C:\Lab Files**, open `ClinicalTerms-RulePackage.xml` in a text editor such as Notepad. Locate the `<IdMatch>` element, which contains the placeholder `idRef="REPLACE-WITH-DICTIONARY-GUID"`, and replace `REPLACE-WITH-DICTIONARY-GUID` with the **Identity** GUID you copied in step 4 (for example, `idRef="6f2161a1-8055-4672-b1a5-d5953ad56d3a"`). Save the file, keeping its **UTF-16 (Unicode)** encoding.
...
1. Import the rule package to create the sensitive information type. This uses the edited `ClinicalTerms-RulePackage.xml` file, which now references your dictionary:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image23.png)

1. Confirm the new sensitive information type exists:

    `Get-DlpSensitiveInformationType -Identity "Contoso Clinical Terms" | Format-List Name, Publisher, Type`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image24.png)

1. Verify the sensitive information type detects the clinical vocabulary. Run a classification test against sample text that contains dictionary terms near a clinical context word:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image25.png)
...
1. Return to the elevated **Terminal (Administrator)** window, still connected to Security & Compliance PowerShell from Task 2. If the session has timed out, reconnect:

    `Connect-IPPSSession -UserPrincipalName AllanD@TenantName`

1. Upload the rule package to create the sensitive information type:

    `New-DlpSensitiveInformationTypeRulePackage -FileData ([System.IO.File]::ReadAllBytes("C:\Lab Files\CompoundID-RulePackage.xml"))`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image26.png)

1. Confirm the new sensitive information type exists:

    `Get-DlpSensitiveInformationType -Identity "Contoso Compound ID" | Format-List Name, Publisher, Type`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image27.png)

1. Verify the sensitive information type detects a compound ID near a context word. Confirm the result lists `Contoso Compound ID` with a count of at least 1:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image28.png)

1. Test with a non-matching sample. The command prints nothing, because `CX-20` has only two digits and no compound identifier is present:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image29.png)
...
1. On the **Sensitive info types** page, select **+ Create Fingerprint based SIT**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image30.png)

1. On the **Name your sensitive info type** page, enter the following, then select **Next**:

    - **Name**:

        `Contoso Consent Form`

    - **Description**:

        `Detects Contoso clinical-trial informed-consent forms using document fingerprinting.`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image31.png)


1. On the **Upload a file to create a fingerprint for the file** page, select **Upload file**.

1. Select the provided `Clinical Trial Consent Form Template.docx` file from **C:\Lab Files**, then select **Open**.

1. Review the detection threshold at the default, then select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image32.png)

1. On the **Review settings and finish** page, review your settings and select **Create**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image33.png)

1. When the SIT is created, select **Done**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image34.png)
...
1. Make sure the **New EDM experience** toggle is set to **On**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image35.png)

1. Select **+ Create EDM classifier**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image36.png)

1. On the naming page, enter the following, then select **Next**:

    - **Name**:

        `Contoso Clinical Trial Subjects`

    - **Description**:

        `Exact match against the Contoso clinical-trial subject registry.`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image37.png)


1. On the schema-method page, select **Manually define your data structure**, then select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image38.png)

1. On the **Define columns** page, add the following four columns. Each must match a header in the provided `ClinicalTrialSubjects.csv` file exactly:
...
1. Select **Next**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image39.png)

1. On the **Select primary elements** page, locate the **SubjectID** row and expand its **Match mode** dropdown. Under **Sensitive Info type (SIT)**, select the edit (pencil) icon, search for `Contoso`, select the **Contoso Clinical Trial Subject ID** SIT you created in Task 1, then select **Save**. Select the checkbox to designate **SubjectID** as a **Primary element**, then select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image40.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image41.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image42.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image43.png)

1. On the **Configure settings for data in selected columns** page, leave **Use the same settings for all columns** set to **On**. Select the option to **Ignore delimiters and punctuation for data in all columns**, then select **Hyphen**, **Underscore**, **Close Parenthesis** and **Open Parenthesis**. Select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image44.png)

1. On the **Configure detection rules for primary elements** page, review the defaults, then select **Next**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image45.png)

1. On the review page, select **Submit**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image46.png)

1. Note the **schema name** shown on the confirmation page, then select **Done**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image47.png)
...
1. Download the EDM Upload Agent. In **Microsoft Edge**, navigate to +++https://go.microsoft.com/fwlink/?linkid=2088639+++ to download the installer.

1. Open the installer. In the setup wizard, select **Next**, accept the license agreement, keep the default destination folder, select **Install**, approve the User Account Control prompt, then select **Finish**.

1. In the elevated terminal, change to the EDM Upload Agent directory:

    `cd "C:\Program Files\Microsoft\EdmUploadAgent"`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image48.png)

1. Authorize the agent. When prompted, sign in as **Allan Deyoung**:

    `.\EdmUploadAgent.exe /Authorize`

1. Download the schema you created. Replace `<schemaName>` with the schema name you noted in step 12:

    `.\EdmUploadAgent.exe /SaveSchema /DataStoreName <schemaName> /OutputDir "C:\Lab Files"`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image49.png)

1. Hash and upload the provided `ClinicalTrialSubjects.csv` file. Replace `<schemaName>` with the same schema name:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image50.png)

1. Check the upload status. Replace `<schemaName>` with the same schema name, and re-run until the status shows completed:

    `.\EdmUploadAgent.exe /GetSession /DataStoreName <schemaName>`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image51.png)
...
1. Test the **Clinical Trial Subject ID** SIT with a matching sample. Confirm the result lists `Contoso Clinical Trial Subject ID` with a count of `1`:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image52.png)

1. Test the same SIT with a non-matching sample. The command prints nothing, because `CTS-45120` has only five digits:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image53.png)

1. Test the **Clinical Terms** SIT with the provided files. In **Microsoft Edge**, in the Microsoft Purview portal, go to **Solutions** > **Information Protection** > **Classifiers** > **Sensitive info types**. Search for `Contoso Clinical Terms`, select it, then select **Test**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image54.png)

1. On the **Upload file to test** flyout, select **Upload file**, select the provided `ClinicalTerms-Match.txt` from **C:\Lab Files**, then select **Open**. Select **Test**. On the **Match results** page, confirm a match is found, then select **Finish**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image55.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image56.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image57.png)

1. Select **Test** again and repeat with `ClinicalTerms-NoMatch.txt`. Confirm the result reports no matches, then select **Finish**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image58.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image59.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image60.png)

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image61.png)

1. Test the **Compound ID** SIT with a matching sample. Confirm the result lists `Contoso Compound ID` with a count of at least 1:

    `(Test-DataClassification -ClassificationNames "Contoso Compound ID" -TextToClassify "Investigational compound CX-2087 confidential formulation.").ClassificationResults | ForEach-Object { "$($_.ClassificationName): $($_.Count)" }`

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image62.png)

1. Test the **EDM classifier** with a record from the registry. In the elevated terminal, run the following and confirm the result lists `Contoso Clinical Trial Subjects` with a count of `1`. The values used are a real record in `ClinicalTrialSubjects.csv`:
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image63.png)
...
1. In **Microsoft Edge**, in the Microsoft Purview portal as **Allan Deyoung**, select **Solutions** > **Information Protection** > **Explorers** > **Content explorer**.
    ...
    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image64.png)

1. In the **Content explorer** view, under **Sensitive info types**, locate and select **Contoso Clinical Trial Subject ID**. The right pane lists the SharePoint, OneDrive, and Exchange locations where content matching that classifier has been found.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image65.png)

1. Select an item in the results to see which classifier matched and where the content resides. Review how Content Explorer lets you confirm that your classifier is detecting real content across the estate.

1. In the left navigation, select **Activity explorer**.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image66.png)

1. In the **Activity explorer** view, use the **Filter** control to filter by **Activity type**. Review the activities recorded against classified content — for example, files being accessed, labeled, or shared.

    ![](https://raw.githubusercontent.com/technofocus-pte/fortifydatasecpurvwdepth/refs/heads/main/Lab%20Guides/Lab-02/media/image67.png)
